...
export default function Collection() {
  ...
  if (isLoading) {
    return (
      <div className="relative w-screen  h-screen font-kalam bg-[url('/backgoundfinal.svg')] bg-contain">
  ...
  return (
    <main className="h-screen mx-auto text-black font-kalam bg-[url('/backgoundfinal.svg')] bg-contain">
      <div className="container  mx-auto px-4 sm:px-6 lg:px-8 py-8  drop-shadow-lg">
        ...
        <div className=" bg-zinc-100  p-4 grid grid-flow-row auto-rows-max rounded-lg grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-4  drop-shadow-lg">
