...
export default function LeaderCard({ leader, place }) {
  ...
  const [cardClasses, setCardClasses] = useState(
    "w-1/2 mx-auto flex justify-between mt-2 px-4 py-2 tracking-wide text-white transition-colors duration-200 transform  rounded  "
  );
  ...
  return (
    ...
    >
      <div className="flex  ">
        <div className="bg-gray-600 p-2 rounded ">{place + 1}</div>
